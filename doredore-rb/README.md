# doredore - Ruby Bindings

[![Gem Version](https://badge.fury.io/rb/doredore.svg)](https://badge.fury.io/rb/doredore)
...
1. Add to `config/initializers/doredore.rb`:
...
### `Doredore::Client.new(db_path, model: nil, cache_dir: nil)`
...
cargo build --package doredore-rb --release

# The shared library will be in target/release/
# - macOS: libdoredore_rb.dylib
# - Linux: libdoredore_rb.so
# - Windows: doredore_rb.dll
```
